    ...
    return (
        <View style={styles.outerContainer}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={[styles.fundInterest, {minHeight:60,marginTop:2 }]}>
                    <View>
                ...
                <View style={[styles.fundInterest, {minHeight:60, }]}>
                    <View>
                ...
                <View style={[styles.fundInterest, {marginTop:0}]}>
                    <View>
                ...
                <View style={[styles.fundInterest, { borderBottomColor: '#969696', borderBottomWidth: 3, marginTop:2.5 }]}>
                    <View>
